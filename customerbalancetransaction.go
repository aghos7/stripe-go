...
const (
	CustomerBalanceTransactionTypeAUABN                    CustomerBalanceTransactionType = "au_abn"
	CustomerBalanceTransactionTypeEUVAT                    CustomerBalanceTransactionType = "eu_vat"
	CustomerBalanceTransactionTypeNZGST                    CustomerBalanceTransactionType = "nz_gst"
	CustomerBalanceTransactionTypeUnknown                  CustomerBalanceTransactionType = "unknown"
	...
	CustomerBalanceTransactionTypeReceiverSourceMispayment CustomerBalanceTransactionType = "receiver_source_mispayment"
	CustomerBalanceTransactionReversal                     CustomerBalanceTransactionType = "reversal"
)

// CustomerBalanceTransactionParams is the set of parameters that can be used when creating a
